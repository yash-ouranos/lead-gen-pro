...
export default function PermissionForm({ initialData }: { initialData?: any }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex-1 p-6 md:p-8 space-y-6 bg-card" noValidate>
      <div>
      ...
      <div>
        <label className="block text-[13px] text-foreground mb-1.5">Value *</label>
        <input
          type="text"
